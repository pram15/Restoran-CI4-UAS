...
class Beli extends BaseController
{
    public function index($id = null)
    {
        ...
        if (isset($id)) {
            ...
            return view('homepage/beli', $data);
        }
    }
    ...
    public function checkout($total = null)
    {
        ...
        if (isset($total)) {
            ...
            $count = count($detail);
            if ($count == 0) {
                $this->insertOrder($idorder, $idpelanggan, $tglorder, $total);
            ...
            return view('homepage/info', $data);
        }
    }
    ...
    public function insertOrder($idorder, $idpelanggan, $tglorder, $total)
    {
        $db = \Config\Database::connect();
